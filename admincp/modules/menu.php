...
?>
<ul class="admin-list">
    <li><a href="index.php?action=quanlydanhmuc&query=lietke">Quản lý danh mục</a></li>
    <li><a href="index.php?action=quanlysanpham&query=lietke">Quản lý sản phẩm</a></li>
    <li><a href="index.php?action=quanlynguoidung&query=lietke">Quản lý người dùng</a></li>
